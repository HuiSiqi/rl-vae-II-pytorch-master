...
log.add_argument('--log-dir',type=str,default=os.path.join('/home/pikey/Data/II','ddpg_vae_a1024_EpsEnv'),help='log directory')
...
env.add_argument('--dst_cp',type=list,default=[0.6,0.6],help="the missing scale of the height and width")
env.add_argument('--dst-bs',type=int,default=256,help="dataset sample batchsize")
env.add_argument('--epslen',type=int,default=10,help="dataset sample batchsize")
...
model.add_argument('--sigma',type=float,default=1,help="action noise variance")
model.add_argument('--gamma',type=float,default=0.9,help="reward decay rate")
...
player = agent.Agent(args.dim_s*2,args.dim_a,gpu,args)
