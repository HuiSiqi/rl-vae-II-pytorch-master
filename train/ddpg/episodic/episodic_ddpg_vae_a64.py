...
env.add_argument('--dst_cp',type=list,default=[0.5,0.5],help="the missing scale of the height and width")
env.add_argument('--dst-bs',type=int,default=256,help="dataset sample batchsize")
env.add_argument('--epslen',type=int,default=10,help="episode length")
...
model.add_argument('--max_a',type=float,default=40,help="max_action")
